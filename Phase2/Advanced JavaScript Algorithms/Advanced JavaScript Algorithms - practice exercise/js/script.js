...
//check if the elements is array
// check if the array is number
//print even number form the array  at even index

// function getOnlyEvens(arry) {
//     // check if the elements is array 
//     let newArry = []
...
// console.log(getOnlyEvens(["a", 1, 2, "1", 4]));
// console.log(getOnlyEvens(0, "a", 2, "1", 4));
...
// check if the function  is number
// check if the function have two digit

function reverseCompare(num){
    
let newString = num.toString().split('').reverse().join('')
