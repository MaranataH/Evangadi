...
var PDFViewerApplication = {
  ...
  load: function load(pdfDocument) {
    ...
    pdfDocument.getMetadata().then(function (_ref5) {
      ...
      //Mani console.log('PDF ' + pdfDocument.fingerprint + ' [' + info.PDFFormatVersion + ' ' + (info.Producer || '-').trim() + ' / ' + (info.Creator || '-').trim() + ']' + ' (PDF.js: ' + (_pdfjsLib.version || '-') + (_app_options.AppOptions.get('enableWebGL') ? ' [WebGL]' : '') + ')');
      var pdfTitle;
...
function webViewerInitialized() {
  ...
  file = null;
  //file ="http://dev.presentica.com/TempFiles/"+docId+".pdf";
...
var defaultOptions = {
  ...
  defaultUrl: {
    value: '/pdf-view/web/compressed.tracemonkey-pldi-09.pdf',
    //value: '/pdf-view/web/test.pdf',
  ...
  workerSrc: {
    value: '/pdf-view/build/pdf.worker.js',
    kind: OptionKind.WORKER
  }
};
{
...
function () {
  function PDFPageView(options) {
    ...
    //manikandan ro add advertisement
    if(this.id % 2 == 0){
      var addDiv = document.createElement('div');
      addDiv.className = 'adver';
      //addDiv.style.width = Math.floor(this.viewport.width) + 'px';
      //addDiv.style.height = Math.floor(280) + 'px';        
      /*var iframeDiv = document.createElement('iframe');
      iframeDiv.src = "/re-ads-space";
      iframeDiv.width ="100%";
      //iframeDiv.height ="100%";
      //addDiv.appendChild(iframeDiv);*/
      //addDiv.innerHTML ='<iframe class="re-ads" src="/re-ads-space" height="50" width="100%" marginheight="0" marginwidth="0" topmargin="0" leftmargin="0" allowtransparency="true" frameborder="0" scrolling="no"></iframe>';
...
document.webL10n = function (window, document, undefined) {
  ...
  function loadLocale(lang, callback) {
    ...
    if (langCount === 0) {
      ...
      if (dict && dict.locales && dict.default_locale) {
        //Mani console.log('using the embedded JSON directory, early way out');
        ...
        //Mani console.log('no resource to load, early way out');
      }
  ...
  function substArguments(str, args, key) {
    ...
    return str.replace(reArgs, function (matched_text, arg) {
      ...
      //Mani console.log('argument {{' + arg + '}} for #' + key + ' is undefined.');
      return matched_text;
    });
  }
